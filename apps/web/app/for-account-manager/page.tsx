...
export default function ForAccountManagerPage() {
    return (
            ...
            <section className="px-6 lg:px-40 py-12 lg:py-20 flex justify-center">
                <div className="max-w-[1240px] w-full">
                    <div className="relative w-full h-[600px] lg:h-[700px] overflow-hidden rounded-4xl bg-white border border-slate-200 shadow-2xl">
                        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2000&auto=format&fit=crop')" }}></div>
                        ...
                        <div className="relative h-full flex flex-col items-center justify-center text-center px-6 md:px-12">
                            <span className="text-primary font-display font-semibold tracking-wider uppercase text-sm mb-4">For Account Managers</span>
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-text-main mb-6 leading-tight">
                                Scale Campaigns with Precision
                            </h1>
                            ...
                            <a href={getAffiliateRegisterUrl()} className="inline-flex items-center px-8 py-4 bg-primary hover:bg-primary-hover text-white rounded-full font-display font-semibold transition-all hover:scale-105 shadow-lg shadow-primary/25">
                                Get Started Now
            ...
            <section className="px-6 lg:px-40 py-24 bg-primary text-white">
                <div className="max-w-[1240px] mx-auto grid grid-cols-3 md:grid-cols-3 gap-12 text-center">
                    <div className="space-y-2">
                        <p className="text-4xl lg:text-5xl font-bold font-display">500+</p>
                        <p className="text-white/70 text-xs font-bold uppercase tracking-widest">Top-Tier Managers</p>
                    </div>
                    <div className="space-y-2">
                        <p className="text-4xl lg:text-5xl font-bold font-display">5x</p>
                        <p className="text-white/70 text-xs font-bold uppercase tracking-widest">More Revenue</p>
                    </div>
                    <div className="space-y-2">
                        <p className="text-4xl lg:text-5xl font-bold font-display">99.2%</p>
                        <p className="text-white/70 text-xs font-bold uppercase tracking-widest">Campaign Success</p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1240px] w-full">
                    <div className="flex flex-col gap-20 text-center items-center">
                        <div className="space-y-4">
                            <span className="text-primary font-bold tracking-widest uppercase text-xs">The 247gbs Edge</span>
                            ...
                            <p className="text-text-secondary text-lg lg:text-xl font-medium max-w-[700px] mx-auto leading-relaxed">
                                Tools that empower managers to lead with data and clarity, eliminating bottlenecks and maximizing team output.
                            </p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
                            {[
                                { title: "Centralized Campaign Hub", desc: "One source of truth for every campaign, client, and creative asset. No more searching through spreadsheets or disjointed email threads.", icon: "hub", color: "bg-primary" },
                                { title: "Team Coordination Tools", desc: "Seamless delegation and real-time task tracking for your entire team. Assign roles, set deadlines, and monitor bandwidth at a glance.", icon: "groups", color: "bg-primary" },
                                { title: "Performance Analytics", desc: "Deep-dive ROI metrics and automated reporting at your fingertips. Identify top performers and scale successful strategies instantly.", icon: "query_stats", color: "bg-primary" }
                            ].map((feature, i) => (
            ...
            <section className="px-6 lg:px-40 py-24 flex justify-center bg-white">
                <div className="max-w-[1100px] w-full rounded-3xl bg-primary px-8 py-24 text-center flex flex-col items-center gap-12 shadow-2xl shadow-primary/40 relative overflow-hidden group">
                    <div className="relative z-10 space-y-8">
                        <h2 className="text-white text-5xl lg:text-7xl font-bold font-display leading-tight tracking-tight">Ready to take command?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 relative z-10 pt-4">
                        <Link href={getAffiliateRegisterUrl()} className="bg-text-main text-white px-14 py-6 rounded-2xl text-xl font-bold shadow-2xl hover:scale-105 active:scale-95 transition-all text-center font-display">Start Your Free Trial</Link>
                    </div>
                </div>
            </section>
